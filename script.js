...
const translations = {
  es: {
    ...
    // desarrollo-art (páginas independientes)
    'home.title': 'La estética de lo efímero',
    'home.desc': 'Descubre una selección curada de obras digitales y físicas emergentes. Un espacio donde los conceptos efímeros se vuelven colecciones permanentes.',
    'home.ctaExplore': 'Explorar exposición',
    'home.ctaCatalog': 'Ver catálogo',
    'home.curatedSelection': 'Selección curada',
    'home.archives': 'Archivos permanentes',
    'exposiciones.pageTitle': 'Exposiciones virtuales',
    'exposiciones.pageDesc': 'Curaduría digital inmersiva. Experimenta la frontera del arte contemporáneo desde cualquier lugar.',
    'exposiciones.current': 'Exposición actual',
    'exposiciones.enter': 'Entrar a la galería',
    'exposiciones.upcoming': 'Próximos programas',
    'galeria.title': 'Excelencia curada',
    'galeria.desc': 'Explora nuestro catálogo definitivo de obras contemporáneas, que reflejan la vanguardia de medios digitales y físicos.',
    'perfil.title': 'Perfil del artista',
    'perfil.desc': 'Biografía y obras seleccionadas del artista.',
    'perfil.role': 'Artista residente',
    'perfil.quote': '"Mi trabajo busca capturar la tensión silenciosa entre la geometría arquitectónica y la naturaleza caótica de la emoción humana."',
    'galeria.feature1': 'Ecos del silencio',
    'exposiciones.currentTitle': 'El jardín sintetizado',
    'sobrenosotros.contactoAnchor': 'Contacto'
  },
  en: {
    menu: 'Menu',
    revista: 'Magazine',
    ...
    // desarrollo-art (independent pages)
    'home.title': 'The aesthetics of the ephemeral',
    'home.desc': 'Discover a curated selection of emerging digital and physical works. A space where ephemeral concepts become lasting collections.',
    'home.ctaExplore': 'Explore exhibition',
    'home.ctaCatalog': 'View catalog',
    'home.curatedSelection': 'Curated selection',
    'home.archives': 'Permanent archives',
    'exposiciones.pageTitle': 'Virtual exhibitions',
    'exposiciones.pageDesc': 'Immersive digital curation. Experience the frontier of contemporary art from anywhere.',
    'exposiciones.current': 'Current exhibition',
    'exposiciones.enter': 'Enter gallery',
    'exposiciones.upcoming': 'Upcoming programs',
    'galeria.title': 'Curated excellence',
    'galeria.desc': 'Browse our definitive catalog of contemporary works reflecting the cutting edge of digital and physical media.',
    'perfil.title': 'Artist profile',
    'perfil.desc': 'Biography and selected works by the artist.',
    'perfil.role': 'Artist in residence',
    'perfil.quote': '"My work seeks to capture the silent tension between architectural geometry and the chaotic nature of human emotion."',
    'galeria.feature1': 'Echoes of Silence',
    'exposiciones.currentTitle': 'The Synthesized Garden',
    'sobrenosotros.contactoAnchor': 'Contact'
  },
  fr: {
    menu: 'Menu',
    revista: 'Magazine',
